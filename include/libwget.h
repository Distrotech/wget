...
void
	wget_http_add_header_vprintf(wget_http_request_t *req, const char *fmt, va_list args) G_GNUC_WGET_PRINTF_FORMAT(2,0) G_GNUC_WGET_NONNULL_ALL;
void
	wget_http_add_header_printf(wget_http_request_t *req, const char *fmt, ...) G_GNUC_WGET_PRINTF_FORMAT(2,3) G_GNUC_WGET_NONNULL_ALL;
void
	wget_http_add_header_line(wget_http_request_t *req, const char *line) G_GNUC_WGET_NONNULL_ALL;
void
